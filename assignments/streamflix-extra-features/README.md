# StreamFlix Extra Features Challenge

Week 6: Converting the movies table into a hybrid system using JSONB for flexible data storage.
...
## Task 1: Adding the Flexible Details Column
...
![Adding JSONB column](images/Pasted%20image%2020260517204351.png)

![Details column added](images/Pasted%20image%2020260517204441.png)
...
## Task 2: Adding Jagged Movie Data
...
![Updating Interstellar](images/Pasted%20image%2020260517204813.png)

Interstellar now has updated technical and casting details:

![Interstellar details](images/Pasted%20image%2020260517204909.png)
...
![Updating Fight Club](images/Pasted%20image%2020260517205819.png)

Here is the return after adding extra details like an added rating and cast members:

![Fight Club details](images/Pasted%20image%2020260517205840.png)
...
![Movies with directors](images/Pasted%20image%2020260517210057.png)
...
![Movies with Brad Pitt](images/Pasted%20image%2020260517210136.png)
...
![Director added to Interstellar](images/Pasted%20image%2020260517210641.png)
...
![Type check](images/Pasted%20image%2020260517210846.png)
...
SET details = jsonb_build_object(
  ...
  'resolution', '4K', 
  'audio', 'Dolby Atmos', 
  'cast', jsonb_build_array('Matthew McConaughey', 'Anne Hathaway')
) 
WHERE title = 'Interstellar';
```
...
![Same output](images/Pasted%20image%2020260517211158.png)
...
![Lion King voice cast query](images/Pasted%20image%2020260517211923.png)

All working!

## Task 4: Creating the GIN Index

If this video streaming platform grows to millions of movies, we would need to be able to search and do it quickly. To index the inside of that column, we will create an index for the movie details using GIN:
...
![EXPLAIN output](images/Pasted%20image%2020260517212518.png)

## Final Result

![Final table state](images/Pasted%20image%2020260517212833.png)
