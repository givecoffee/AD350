...
![create query](../images/Pasted%20image%2020260516231225.png)
![create query result](../images/Pasted%20image%2020260516231154.png)

movies has been created:

![movies table confirmed](../images/Pasted%20image%2020260516231302.png)
...
![alter and rename query](../images/Pasted%20image%2020260516231750.png)
...
![updated table with viewer_rating and category](../images/Pasted%20image%2020260516232054.png)
...
![temporary table query and result](../images/Pasted%20image%2020260516232500.png)
...
![supabase drop warning](../images/Pasted%20image%2020260516232933.png)

I proceeded to create a new table with junk data:

![junk table query](../images/Pasted%20image%2020260516233309.png)
![junk table created](../images/Pasted%20image%2020260516233221.png)

Now, to DROP the table that is no longer needed:

![drop query](../images/Pasted%20image%2020260516233415.png)
